"""
Scene Complexity Detector for Approach 2.5
...
def get_adaptive_max_tokens(complexity: Literal['simple', 'medium', 'complex']) -> int:
    """
    Get adaptive max_tokens based on complexity
    ...
    if complexity == 'simple':
        return 100  # Fewer tokens for simple scenes
    elif complexity == 'medium':
        return 150  # Moderate tokens
    else:  # complex
        return 200  # More tokens for complex scenes
